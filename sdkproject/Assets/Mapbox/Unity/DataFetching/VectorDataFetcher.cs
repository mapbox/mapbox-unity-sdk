...
namespace Mapbox.Unity.DataFetching
{
	public class VectorDataFetcher : DataFetcher
	{
		...
		{
			var vectorTile = (useOptimizedStyle) ? new Mapbox.Map.VectorTile(tileId, tilesetId, optimizedStyle.Id, optimizedStyle.Modified) : new Mapbox.Map.VectorTile(tileId, tilesetId);
		...
		private void FetchingCallback(CanonicalTileId tileId, Mapbox.Map.VectorTile vectorTile, UnityTile unityTile = null)
		{
