...
[CustomEditor(typeof(SphereTerrainFactory))]
public class SphereTerrainFactoryEditor : FactoryEditor
{
	private string _defaultMapId = "mapbox.terrain-rgb";
	private SphereTerrainFactory _factory;
	...
	void OnEnable()
	{
		_factory = target as SphereTerrainFactory;
		...
		script = MonoScript.FromScriptableObject((SphereTerrainFactory)target);
	}
