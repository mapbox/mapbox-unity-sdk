namespace Mapbox.Examples
{
	...
	public class POIPlacementScriptExample : MonoBehaviour
	{
		...
		void Start()
		{
			...
			map.MapVisualizer.VectorLayer.SpawnPrefabByCategory(prefab, LocationPrefabCategories.ArtsAndEntertainment, 10, HandlePrefabSpawned, true, "SpawnFromScriptLayer");
