...
Shader "CharacterBuildingShader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Albedo = ( lerpResult39 * triplanar41 ).rgb;
			o.Emission = ( triplanar41 * _EmissionColor * _EmissionPower ).xyz;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=13101
7;29;1936;1116;2447.333;1025.005;1.606836;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;43;-1184.36,-261.7579;Float;False;Property;_Tile;Tile;6;0;1;0;0;0;1;FLOAT
...
ASEEND*/
//CHKSM=1F5E2397170443EE1DE3DB95CD6463BC4670056C