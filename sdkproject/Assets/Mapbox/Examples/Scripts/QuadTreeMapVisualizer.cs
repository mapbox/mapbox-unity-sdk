namespace Mapbox.Unity.Map
{
    ...
    public class QuadTreeMapVisualizer : AbstractMapVisualizer
    {
        protected override void PlaceTile(UnwrappedTileId tileId, UnityTile tile, IMapReadable map)
        {
            ...
            var centerMerc = map.CenterMercator;
            ...
            var centerMercID = Conversions.MetersToTile(centerMerc, map.Zoom);
            ...
            float factor = Conversions.GetTileScaleInMeters(0f, _map.Zoom) * 256.0f;
            ...
            Vector3 position = new Vector3(
                ((tileId.X - centerTile.X) - shiftX) * scaleFactor * unityTileSize
                , 0
                , ((centerTile.Y - tileId.Y) - shiftY)* scaleFactor * unityTileSize);
