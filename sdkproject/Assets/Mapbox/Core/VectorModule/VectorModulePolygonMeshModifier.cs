...
namespace Mapbox.Unity.MeshGeneration.Modifiers
{
	...
	/// </summary>
	[CreateAssetMenu(menuName = "Mapbox/Modifiers/Vector Module Polygon Mesh Modifier")]
	public class VectorModulePolygonMeshModifier : MeshGenerationBase
	{
		...
		public override void Run(VectorFeatureUnity feature, MeshData md, UnityTile tile = null)
		{
			...
			{
				_currentFacade = _options.atlasInfo.Roofs[Random.Next(0, _options.atlasInfo.Roofs.Count)];
				...
				var _textureUvCoordinates = new Vector2[md.Vertices.Count];
