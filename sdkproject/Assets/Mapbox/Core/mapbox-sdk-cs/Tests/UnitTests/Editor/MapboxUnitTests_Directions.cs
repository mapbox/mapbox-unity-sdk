...
namespace Mapbox.MapboxSdkCs.UnitTest
{
	...
	internal class DirectionsTest
	{
		...
		{
#if MAPBOX_PLAYMODE_TESTS
			Debug.Log("'MAPBOX_PLAYMODE_TESTS' set");
#endif

#if UNITY_EDITOR
			Debug.Log("'UNITY_EDITOR' set");
#endif

#if UNITY_STANDALONE
			Debug.Log("'UNITY_STANDALONE' set");
#endif
		}


		https://answers.unity.com/questions/533941/can-rsp-files-be-located-other-than-asset-root.html
			https://gist.github.com/unitycoder/9ebeccd3680c04b101d3fd96121fc38e
...
#if MAPBOX_PLAYMODE_TESTS
			UnityEngine.Debug.Log("running SerializesAndDeserializesBasic");
...
#if MAPBOX_PLAYMODE_TESTS
			UnityEngine.Debug.Log("running SerializesAndDeserializesWithSteps");
			// First, deserialize the example response.
